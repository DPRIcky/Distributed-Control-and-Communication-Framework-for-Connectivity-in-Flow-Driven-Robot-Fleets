...
class DistributedNetwork:
    ...
    def goal_seeking_simulation(self, goal_x, goal_y):
        ...
        self.goal_switch_interval = 150  # frames to show each goal
        self.goal_visible = True         # goals are always visible
        self.goal_switch_counter = 0
        
        # Random goal generation parameters
        self.workspace_bounds = [-8, 8, -8, 8]  # [x_min, x_max, y_min, y_max]
        ...
        def animate_goal_seeking(frame):
            ...
            # Debug: Print counter every 30 frames
            if self.goal_switch_counter % 30 == 0:
                print(f"🔄 DEBUG: Goal switch counter: {self.goal_switch_counter}/{self.goal_switch_interval}")
            
            # Check if it's time to switch to next goal location
            if self.goal_switch_counter >= self.goal_switch_interval:
                # Generate new random goal location within workspace bounds
                ...
                print(f"🎯 New random goal generated: ({goal_x:.1f}, {goal_y:.1f})")
